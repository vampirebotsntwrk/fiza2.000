...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/vampirebotsntwrk/fiza2.000",)
...
autoclean = []
confirmer = {}
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/6glxhs.mp4")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/6glxhs.mp4")
PLAYLIST_IMG_URL = "https://files.catbox.moe/f2s4ws.jpg"
STATS_IMG_URL = "https://files.catbox.moe/6glxhs.mp4"
